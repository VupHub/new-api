...
const FooterBar = () => {
  ...
  const icpFilingNumber = DEFAULT_ICP_FILING_NUMBER.trim();
  ...
  const customFooter = useMemo(
    ...
    [logo, systemName, t, currentYear, isDemoSiteMode, icpFilingNumber],
  );
