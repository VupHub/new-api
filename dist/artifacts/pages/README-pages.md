...
- Upload directly to GitHub Pages, Cloudflare Pages, or another static hosting platform
...
- The default frontend mainly calls the backend through same-origin /api, so it works best with:
  ...
  - a gateway in front of Pages that forwards /api, /mj, and /pg to the backend
